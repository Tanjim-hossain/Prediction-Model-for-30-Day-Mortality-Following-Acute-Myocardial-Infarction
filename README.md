...
### 1. What Drives Mortality? (Medical Interpretation)
...
### 2. How Accurate is the Model? (Performance)
...
* **Reliability:** The model also scored well on "calibration" (Brier Score: 0.169), meaning the probabilities it predicts (e.g., "80% risk") are realistic.
